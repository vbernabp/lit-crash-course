...
export const herramientasProduccionSection = html`
  ...
  <a href="https://lit.dev/docs/tools/production/" target="_blank" rel="noopener noreferrer">Más información sobre producción</a>
`
