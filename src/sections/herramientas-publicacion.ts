...
export const herramientasPublicacionSection = html`
  ...
  <p>Registra siempre el custom element en el mismo módulo donde se declara la clase, y exporta la clase para permitir la extensión y el uso en registries con scope en el futuro. Consulta la <a href="https://github.com/webcomponents/gold-standard/wiki" target="_blank" rel="noopener noreferrer">Gold Standard Checklist</a> para mejores prácticas adicionales.</p>
  <div>
