...
export const herramientasPlantillasInicioSection = html`
  ...
  <a href="https://lit.dev/docs/tools/starter-kits/" target="_blank">Más información sobre plantillas de inicio</a>
`
