...
export const herramientasRequisitosSection = html`
  ...
  <p>Lit se publica como ES2021 y utiliza importaciones con bare module specifiers, además de APIs modernas como <lc-code>template</lc-code>, custom elements y shadow DOM. Estas características están soportadas por los navegadores modernos y las herramientas populares de desarrollo.</p>
  ...
  <a href="https://lit.dev/docs/tools/requirements/" target="_blank">Más información sobre requisitos</a>
`
